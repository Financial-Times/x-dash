...
type CCPAConsentData = Record<'behaviouralAds' | 'demographicAds' | 'programmaticAds', CategoryPayload>
...
type OnSaveCallback = (err: null | Error, data: { consent: boolean; payload: CCPAConsentPayload }) => void
